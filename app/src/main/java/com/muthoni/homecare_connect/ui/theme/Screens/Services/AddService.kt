...
fun AddService(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        var serviceCharge by remember { mutableStateOf(TextFieldValue("")) }
        ...
        Button(onClick = {
            ...
            serviceRepository.saveService(serviceName.text.trim(), serviceCharge.text)
        ...
        ImagePicker(Modifier,context, navController, serviceName.text.trim(), serviceCharge.text.trim())
...
@Composable
fun ImagePicker(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, charge:String) {
    ...
    Column(modifier = modifier,) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                var serviceRepository = ServiceViewModel(navController,context)
                serviceRepository.saveServiceWithImage(name,charge,imageUri!!)
...
@Composable
fun Addservprev() {
    AddService(rememberNavController())
